...
// function calculateSum(totalNumbers){
//     let index = 0;
//     let totalSum = 0;
//     while (index < totalNumbers.length){
        
//         totalSum = totalSum + totalNumbers[index];
//         index++;
//     }
...
// function calculateAverage(totalNumbers){
//     let index = 0;
//     let totalSum = 0;
//     while (index < totalNumbers.length){
...
//     console.log("The Average is ", totalSum/index);
// }

// calculateAverage(totalNumbers);
...
// let index = 0;
//     let highestNumber = largestNumbers[index];
    
//     while (index < largestNumbers.length-1){
//         if(highestNumber<largestNumbers[index+1]){
//             highestNumber = largestNumbers[index+1];
//         }   
//         index++;
